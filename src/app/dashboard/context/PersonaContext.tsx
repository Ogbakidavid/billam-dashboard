...
import { JobState, QuoteStatus, BusinessType } from '@/app/dashboard/types';
...
const personaData: Record<PersonaKey, PersonaData> = {
  event_decoration: {
    ...
    quotes: [
      ...
      { id: 'qt-ed-006', client: 'Chioma Obi', event: 'Birthday Styling', amount: 310000, status: 'expired', created: 'Aug 10, 2026', updated: '21d ago' },
    ],
  },
  photography: {
    key: 'photography',
    ...
    quotes: [
      ...
      { id: 'qt-ph-004', client: 'Yetunde Adeyemi', event: 'Graduation Shoot', amount: 75000, status: 'draft', created: 'Aug 31, 2026', updated: '4h ago' },
    ],
  },
  tailoring: {
    key: 'tailoring',
    ...
    quotes: [
      { id: 'qt-tl-001', client: 'Tunde Bello', event: 'Bespoke Suits — 3 pieces', amount: 185000, status: 'awaiting_approval', created: 'Sep 1, 2026', updated: '4m ago' },
      { id: 'qt-tl-002', client: 'Amaka Eze', event: 'Corporate Uniforms x5', amount: 175000, status: 'awaiting_approval', created: 'Aug 29, 2026', updated: '8h ago' },
      { id: 'qt-tl-003', client: 'Femi Kuti', event: 'Bespoke Suit — 2 pieces', amount: 125000, status: 'sent', created: 'Aug 27, 2026', updated: '2h ago' },
      { id: 'qt-tl-004', client: 'Sade Adu', event: 'Corporate Uniforms x10', amount: 340000, status: 'draft', created: 'Aug 31, 2026', updated: '5h ago' },
    ],
  },
  catering: {
    key: 'catering',
    ...
    quotes: [
      ...
      { id: 'qt-ct-002', client: 'Fatima Bello', event: 'Cocktail Event', amount: 245000, status: 'awaiting_approval', created: 'Aug 29, 2026', updated: '12h ago' },
      { id: 'qt-ct-003', client: 'Tunde Bello', event: 'Corporate Catering', amount: 185000, status: 'sent', created: 'Aug 27, 2026', updated: '4h ago' },
      { id: 'qt-ct-004', client: 'Amaka Nwosu', event: 'Birthday Catering', amount: 195000, status: 'draft', created: 'Aug 31, 2026', updated: '3h ago' },
    ],
  },
  event_planning: {
    key: 'event_planning',
    ...
    quotes: [
      ...
      { id: 'qt-ep-004', client: 'Amara Obi', event: 'Birthday Party Planning', amount: 450000, status: 'draft', created: 'Aug 31, 2026', updated: '4h ago' },
    ],
  },
  equipment_rental: {
...
export function PersonaProvider({ children }: { children: ReactNode }) {
  ...
  return (
    <PersonaContext.Provider value={{
      currentPersona: personaData[currentKey],
