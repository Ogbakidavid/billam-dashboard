  ...
  return (
    <div className="relative" ref={ref}>
      ...
      >
        ...
        <span className="hidden sm:inline truncate max-w-30">{currentPersona.label}</span>
            ...
            {navItems.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  {active && (
                    <span className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-px w-1 h-5 bg-[#19D66B] rounded-full" />
                  )}
                </Link>
              );
            })}
          ...
          <div className="flex flex-col gap-0.5 pt-3 border-t border-[#E7E7E3]">
            {bottomNavItems.map((item) => (
              <Link
                key={item.href}
                href={item.href}
                className="flex items-center gap-3 w-full px-3 py-2.5 rounded-[14px] text-[#6F716E] hover:bg-[#F0F0EE] hover:text-[#171817] transition-all duration-150"
              >
